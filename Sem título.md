...
- Força (FOR), ou a capacidade de resistir fisicamente a algo.
- Destreza (DES), ou a acuidade para se esquivar de algo.
- Vontade (VON), ou a mentalidade para não ser persuadido por algo.
...
Um Personagem Não Jogável (NPC) não rola sob efeito de  qualquer Vantagem ou Desvantagem. Se algo o afeta positiva ou negativamente, isso deve refletir nos testes dos PJs apenas
...
Algumas ações e situações fazem com que um Personagem receba um Cansaço. Cada unidade de Cansaço ocupa um espaço no inventário. Se um PJ receber um Cansaço sem ter espaços livres, ele terá de largar algum item para liberar o espaço. Uma personagem pode se recuperar de 1 nível de Cansaço após comer uma marmita durante um Descanso Rápido.
### Sobrecarga
...
### 1. Definindo Salvaguardas
Role um 3d6, um dado para cada salvaguarda, para determinar os valores do seu PJ conforme a tabela abaixo. O valor máximo que um PJ pode ter em uma salvaguarda é 8.
...
| 4-5 | 14          |
| 6   | 13          |
### 2. Escolhendo um "Arquétipo"
Esse pedaço do jogo é um placeholder para facilitar o playtest, eles são esboços de "classes", mas o objetivo futuro é não haver uma distinção tão rígida assim

Selecione um Arquétipo de sua preferência, anote os equipamentos em seus respectivos espaços de inventário

1. GUERREIRO: Espada(4 dano, 1d8), Escudo, Armadura Leve, 5 Marmitas de Viagem (1 espaço);
2. LADRÃO: Adaga (3 dano, 1d6), Corda (15m), Bolas de Gude, 5 Marmitas de Viagem;
3. MAGO: Grimório com 1 magia, Bastão de Exploração (2m), 6 Tochas (1 espaço), 5 Marmitas de Viagem;
4. BATEDOR: Arco (3 dano, 1d6), 20 flechas (1 espaço), Armadura Leve, Apito, 5 Marmitas de Viagem;
### 3. Anote o restante
Cada PJ possui 1 Dado de Vida, anote também a Taxa de Movimento com base na tabela das seções anteriores e, por fim, dê um nome legal ao seu Personagem.

Agora... o restante das regras!
