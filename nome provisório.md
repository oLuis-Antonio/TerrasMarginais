...
---
# Apresentação (NÃO PULE)

Não vou me delongar, porque todo jogador experiente de RPG ignora as introduções, mas este texto é relevante para apresentar a proposta do playtest e o cenário que compõe o jogo, estejam avisados.

NOME PROVISÓRIO é um RPG de fantasia mineiro até os ossos. 

Vocês estarão jogando na Terra do Sol, onde o mar mais próximo é um de morros, serras e montanhas. A Terra do Sol é um lugar isolado, onde Cidades-Estado mantém certa autonomia, ao mesmo tempo que sofrem a imposição da Coroa de Além-mar. A Coroa é quem invadiu, escravizou e colonizou essas terras enquanto buscava por algo, já esquecido há seculos.

Vocês não são revolucionários, nem heróis ou qualquer tipo de pessoa especial. O jogo acontece a partir da perspectiva dos Tropeiros, pessoas que viajam em grupo de cidade em cidade resolvendo todo o tipo de trabalhos. Porém, nossa mesa de playtest será ligeiramente diferente.

Sigam o passo a passo para a criação de personagens na próxima seção. Assim que tiverem um personagem em mãos, evoluam-no até o nível 5 seguindo as orientações daquela seção. Sim, será uma mesa de "nível alto" para testar o sistema no limite. Não tenham medo de arriscar seus personagens, ou sequer de deixá-los morrer. Tenham medo é **do que a morte fará com seus personagens**. Memento Mori.
...
Em qualquer Teste de Salvaguarda, para cada Vantagem ou Desvantagem, role um d6 adicional. Considere apenas o maior resultado entre os dados extras. Se o dado rolado é uma Vantagem, o maior valor tirado é somado ao resultado. Se o dado rolado é uma Desvantagem, o maior valor tirado é subtraído do resultado.
...
- **Turnos**: tempo de exploração em locais fechados ou subterrâneos, equivalem a aproximadamente 10 minutos no jogo;
- **Rodadas**: compreendem o tempo de ação dos dois lados de um combate.
### Taxa de Movimento
...
Transportar carga, resgatar algo, proteger alguém. Tudo isso são trabalhos que uma tropa pode se comprometer a realizar. Para além de mercenários, os tropeiros resolvem problemas dos outros em suas viagens, sem se limitar ao cumprimento estrito de sua função. Nunca se sabe o que mais se pode encontrar pelo caminho.

É claro, todo trabalho envolve um Destino: zonas de interesse como vilas, cidades, acidentes geográficos ou qualquer área que possa ser explorada em maiores detalhes. Os Destinos são o ponto de chegada, geralmente relacionado a algum trabalho. É a partir do Destino que a tropa pode traçar o Caminho que irá tomar para viajar.
### Caminhos
...
Personagens são indivíduos que passam por todo o tipo de situações: das mais bobas as mais ardilosas, arriscadas e, principalmente, transformadoras. Isso, é claro, reflete diretamente no seu progresso de jogo. Em *nome do jogo* não existem pontos de experiência, mas sim **Vivências**. Vivências são reflexos do desenvolvimento e evolução de um PJ divididos em 4 categorias:

- Combate: a sua experiência adquirida por cicatrizes em batalha;
- Exploração: a sua experiência adquirida por conhecer o mundo;
...
A lista a seguir traz uma série de perguntas a serem feitas para ajudar a determinar se uma determinada marca foi alcançada durante a sessão:
...
Nesta seção, estarão presentes alguns materiais de apoio como listas de Equipamentos, Feitiços e NPCs.
